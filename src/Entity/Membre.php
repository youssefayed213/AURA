...
class Membre
{
    ...
    #[ORM\OneToMany(mappedBy: 'id_Membre', targetEntity: Don::class)]
    private Collection $dons;

    #[ORM\OneToMany(mappedBy: 'membre', targetEntity: Commentaire::class)]
    private Collection $commentaires;

    #[ORM\OneToMany(mappedBy: 'membre', targetEntity: Facture::class)]
    private Collection $factures;

    #[ORM\OneToMany(mappedBy: 'membre', targetEntity: Achat::class)]
    private Collection $achats;

    #[ORM\OneToMany(mappedBy: 'membre', targetEntity: FraisEnergie::class)]
    ...
    #[ORM\OneToMany(mappedBy: 'Membre', targetEntity: Terrain::class)]
